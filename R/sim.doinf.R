...
#'
#' \code{sim.doinf} returns a data.frame with a subset of the Declarations of Death - Children (DOINF) dataset
#' 
#' @details
...
#'
#' pr10 <- sim.doinf(2010)
sim.doinf <- function(years, language = datasus.lang()) {
    sim.load("DOINF", years, language = language)
}