...
#' Provides Access to the Declarations of Death Dataset
#'
#' This function provides an interface to the Declarations of Death (DO) dataset from the Mortality Information System (SIM).
#' @details
...
#' 
#' The function \code{sim.dores} reads the DO type (sometimes also referred as DORES). Other \code{sim.*} functions are provided for each available subsystem, for example, \code{sim.dofet}, \code{sim.doext} and so on.
#' 
#' @note
...
sim.dores <- function(years, states, english = TRUE) {
